  ...
  public:
    ...
    DigitizedClusterGT(bool isValid, float pt_f, float phi_f, float eta_f) {
      ...
      clusterData = ((ap_uint<64>)digitizeIsValid(isValid)) |
                    ...
                    (((ap_uint<64>) digitizePhi(phi_f) << 17) & 0x3FFE0000) | // 0x3FFE0000 is all zero's except the phi bits (bits 17 through 29)
                    (((ap_uint<64>) digitizeEta(eta_f) << 30) & 0xFFFC0000000);  // 0xFFFC0000000 is all zero's except the eta bits (bits 30 through 32)
    }
