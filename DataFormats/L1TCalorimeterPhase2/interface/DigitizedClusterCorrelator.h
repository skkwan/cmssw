  ...
  public:
    ...
    DigitizedClusterCorrelator(ap_uint<12> pt,
      ...
      clusterData = ((ap_uint<64>)pt) |
                    (((ap_uint<64>)etaCr) << 12) | (((ap_uint<64>)phiCr) << 20) |
                    (((ap_uint<64>)hoe) << 27) | (((ap_uint<64>)hoeFlag) << 31) |
    ...
    DigitizedClusterCorrelator(float pt_f,
      ...
      clusterData = (((ap_uint<64>) digitizePt(pt_f)) | 
                     ...
                     ((ap_uint<64>) digitizeHoE(hoe) << 27) |
                     ((ap_uint<64>) digitizeHoeFlag(hoeFlag) << 31) | 
    ...
    float realPhi() const { 
      ...
      int offset_tower = 0;
      if (cardNumber() == 0)      { offset_tower = correlatorCard0_tower_iphi_offset; }
      else if (cardNumber() == 1) { offset_tower = correlatorCard1_tower_iphi_offset; }
