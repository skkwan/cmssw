...
l1tLayer1Barrel = cms.EDProducer("L1TCorrelatorLayer1Producer",
    ...
    emRawClusters = cms.VInputTag(cms.InputTag('l1tPhase2GCTBarrelToCorrelatorLayer1Emulator', 'GCTEmDigiClusters')),
    hadRawClusters = cms.VInputTag(cms.InputTag('l1tPhase2GCTBarrelToCorrelatorLayer1Emulator', 'GCTHadDigiClusters')),
